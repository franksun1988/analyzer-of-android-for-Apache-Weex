...
class OkHttpWebSocketClient extends WebSocketClient {
    ...
    public OkHttpWebSocketClient(IWebSocketBridge proxy) {
        super(proxy);
    ...
    private void abort(String message, Throwable cause) {
        WXLogUtils.v(TAG, "Error occurred, shutting down websocket connection: " + message);
        close();
