...
public class ScalpelFrameLayout extends FrameLayout {
    ...
    public void setOnDrawViewNameListener(OnDrawViewNameListener listener) {
    ...
    public void setDrawViewNames(boolean isDrawViewNames) {
        if (this.isDrawViewNames != isDrawViewNames) {
            this.isDrawViewNames = isDrawViewNames;
            invalidate();
        }
    }
    ...
    public void draw(@SuppressWarnings("NullableProblems") Canvas canvas) {
        ...
        while (!layeredViewQueue.isEmpty()) {
            ...
            if (isDrawViewNames && !drawIds) {
                String className = view.getClass().getSimpleName();

                if (mListener != null) {
                    className = mListener.onDrawViewName(view, className);
                }
