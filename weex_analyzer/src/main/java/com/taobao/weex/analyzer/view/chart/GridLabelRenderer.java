...
public class GridLabelRenderer {
     ...
     */
    public GridLabelRenderer(ChartView graphView) {
     ...
     * Normally you should always call {@link ChartView#onDataChanged(boolean, boolean)}
    ...
    protected void calcLabelVerticalSize(Canvas canvas) {
        ...
        // add some pixel to getPerformanceList a margin
